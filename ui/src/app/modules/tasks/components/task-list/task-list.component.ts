        ...
        <mat-card class="mat-elevation-z8 task-list__outer-card-layer">
            <div class="task-list__todo-table-card">
                <mat-card class="mat-elevation-z2">
                    ...
                    <table mat-table [dataSource]="_tasks" class="task-list__todo-table">
            ...
            <div class="task-list__in-review-table-card">
                <mat-card class="mat-elevation-z2 ">
                    ...
                    <table mat-table [dataSource]="_tasks2" class="task-list__in-review-table">
                        <ng-container matColumnDef="subject">
                            <th mat-header-cell *matHeaderCellDef>Subject</th>
                            <td mat-cell *matCellDef="let task">{{task.subject}}</td>
                        </ng-container>
...
export class TaskListComponent {
    private displayedColumns = ['subject', 'status', 'type', 'creationDateTime'];
    private _tasks: Task[];
    private _tasks2: Task[];
